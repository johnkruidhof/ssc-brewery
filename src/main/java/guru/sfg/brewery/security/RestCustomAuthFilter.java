...
@Slf4j
public abstract class RestCustomAuthFilter extends AbstractAuthenticationProcessingFilter {

    public RestCustomAuthFilter(RequestMatcher requiresAuthenticationRequestMatcher) {
    ...
    public Authentication attemptAuthentication(HttpServletRequest httpServletRequest,
        ...
        log.debug("Autheticating user: "+userName);
